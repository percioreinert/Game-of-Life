    ...
    public static void tabuleiro(Jogador jogador)
    {
        ...
        {  switch(casa)
        {
            case 1:
                ...
                break;
            case 2:
                System.out.println("Dia de pagamento,receba R$XX.XX.");
                jogador.setContaCorrente(800);
                break;
            case 3:
                System.out.println("Você machucou durante a viagem, foi descontado R$1.000.");
        ...
        {  casa = 19;//parada obrigatória:  compra da casa modelo Bluth
            ...
            switch(casa)
            {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    System.out.println("PARADA OBRIGATÓRIA!\nPARABÉNS !!! Você casou com uma pessoa muito especial. Perca R$XX,XX.");
                    break;
                case 14:
                ...
                case 18:
                    ...
                    break;
                case 19:
                    System.out.println("Parada Obrigatória\nVocê comprou uma casa modelo Bluth. Perca R$XX.XXX.");
                    break;
                case 20:
        ...
        {  switch(casa)
        {
            ...
            case 40:
                ...
                break;
            case 41:
                System.out.println("Você comprou um bar o \"Queen Mary\".");
                break;
            case 42:
            ...
            if(!direcao)
                switch(casa)
                {
                    ...
                    case 44:
                        ...
                        break;
                    case 45:
                        System.out.println("Você descobre qeu seu pai possui uma amante morando com ele. Perca 1 turno.");
                        break;
                }
            else
                switch(casa)
        ...
        {  switch(casa)
        {
            ...
            case 54:
                ...
                break;
            case 55:
                System.out.println("Você começou seu próprio negócio, isso resulta em um investimento do próprio bolto. Investimento R$15.000.");
                break;
            case 56:
                System.out.println("Você ajudou dua filho(a) a começar seu próprio negócio de biscoitos. Investimento R$750.");
                break;
            case 57:
                System.out.println("Você tirou um dia de folga e foi em um concerto musical da Joan Baez. Perca 1 turno.");
                break;
            ...
            case 69:
                ...
                break;
            case 70:
                System.out.println("PARABÉNS !!! VOCÊ VENCEU O JOGO DA VIDA");
                break;
        }
        }
    }
